            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <c:if test="${user != null}">
                        ...
                        <input type="hidden" name="superUser" value="<c:out value='${user.superUser}' />" />
                    </c:if>
                    ...
                    <div class="row register-form">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="dateOfBirth" class="form-control" value="<fmt:formatDate value="${user.dateOfBirth}" pattern="yyyy-MM-dd" />" placeholder="DATA DI NASCITA *" onfocus="(this.type='date')" title="Data di Nascita" required />
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="fiscalCode" class="form-control" maxlength="16" minlenght="16" style="text-transform:uppercase" value="<c:out value='${user.fiscalCode}' />" placeholder="Codice Fiscale *" title="Codice Fiscale" required />
                            </div>
                            <div class="form-group">
